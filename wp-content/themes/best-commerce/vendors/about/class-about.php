	...
	class Best_Commerce_About {
		...
		public function load_assets( $hook ) {
			...
			if ( 'appearance_page_' . $this->page_slug === $hook ) {
				...
				wp_enqueue_style( 'best-commerce-about', get_template_directory_uri() . '/vendors/about/css/about' . $min . '.css', array(), '2.0.2' );
				wp_enqueue_script( 'best-commerce-about', get_template_directory_uri() . '/vendors/about/js/about' . $min . '.js', array( 'jquery' ), '2.0.2' );
				$js_vars = array(
