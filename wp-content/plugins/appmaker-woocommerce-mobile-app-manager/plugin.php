...
class APPMAKER_WC {
	...
	public static function init() {
		...
		if ( is_admin() ) {
			require_once dirname( __FILE__ ) . '/lib/class-appmaker-wc-options.php';
			require_once dirname( __FILE__ ) . '/lib/class-appmaker-wc-admin-hooks.php';
		...
		require_once dirname( __FILE__ ) . '/lib/class-appmaker-wc-coupon.php';
	}
